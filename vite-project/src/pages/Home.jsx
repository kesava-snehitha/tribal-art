    ...
    <div className="home-page">
      ...
      <section className="categories">
        ...
        <div className="categories-grid">
          <Link to="/products" className="category-card textiles">
          ...
          <Link to="/products" className="category-card pottery">
            <span className="cat-emoji">🏺</span>
            <h3>Pottery</h3>
          </Link>
          <Link to="/products" className="category-card sculpture">
            <span className="cat-emoji">🗿</span>
            <h3>Sculpture</h3>
          </Link>
          <Link to="/products" className="category-card painting">
            <span className="cat-emoji">🎨</span>
            <h3>Paintings</h3>
          </Link>
          <Link to="/products" className="category-card woodcraft">
            <span className="cat-emoji">🪵</span>
            <h3>Woodcraft</h3>
          </Link>
        </div>
