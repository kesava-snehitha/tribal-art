    ...
    <nav className="navbar">
      <div className="navbar-container">
        ...
        <div className={`navbar-menu ${mobileMenuOpen ? 'active' : ''}`}>
          ...
          <Link to={isLoggedIn ? "/products" : "/login"} className="nav-link" onClick={() => setMobileMenuOpen(false)}>Products</Link>
          <Link to="/exhibition" className="nav-link" onClick={() => setMobileMenuOpen(false)}>Exhibitions</Link>
          <Link to="/commission" className="nav-link" onClick={() => setMobileMenuOpen(false)}>Commissions</Link>
